...
//
public class UrlHTTPSRequest extends AsyncTask<String, Integer, JSONObject> {
    private static final String HTTPS_STRING = "https";

    private static final String PROXY_ADDRESS = "10.156.2.19";
    ...
    public UrlHTTPSRequest(Context context, AsyncTaskCompleteListener<JSONObject> listener) {
        //UrlHttpRequest.context = super.getClass().getApplicationContext();
        UrlHTTPSRequest.activity = (Activity) context;
